    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Tabel Galeri</h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" aria-describedby="dataTables-example_info">
                                    <button class="btn btn-success" data-toggle="modal" data-target="#tambah">Tambah Galeri</button>
                                    ...
                                    <?php 
                                        ...
                                        $hasilselect=mysqli_query($connection,$select);
                                    ...
                                    <tr>
                                            ...
                                            <td><button class="btn btn-success" data-toggle="modal" data-target="#edit<?php echo $row['id_gambar'] ?>">Edit Foto</button></td>
                                            <td><button class="btn btn-danger" data-toggle="modal" data-target="#hapus<?php echo $row['id_gambar'] ?>">Hapus Galeri</button></td>
                                    
                                    </tr>

                                    <?php include("editgaleri.php"); ?>
                                    <?php include("hapusgaleri.php"); ?>
