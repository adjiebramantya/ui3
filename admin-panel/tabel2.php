    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Tabel Harga Padi</h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" aria-describedby="dataTables-example_info">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeA odd">
                                            ...
                                            <td class="center ">
                                                <button class="btn btn-danger" data-toggle="modal" data-target="#hapus<?php echo $row['id_harga'] ?>">HAPUS</button>
                                            </td>
                                        </tr>

                                        <?php include("editharga.php"); ?>
                                        <?php include("hapusharga.php") ?>
                                        <?php } ?>
                                    </tbody>
                                </table>
                            </div>
