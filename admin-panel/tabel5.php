    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Tabel Manajemen Artikel</h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <button class=" btn btn-success" name="tambah"><a href="tambahartikel.php" style="color: white">Tambah Artikel</a></button>
                            <?php
